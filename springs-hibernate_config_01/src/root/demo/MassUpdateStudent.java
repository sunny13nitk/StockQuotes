...
public class MassUpdateStudent
{
	...
	)
	{
		...
		try
		{
			...
			Query stbyLname_Q = sess.createQuery(
			        "update Student set lastName =:lv_lastName where email  LIKE :lv_email_domain");
			if (stbyLname_Q != null)
			{
				stbyLname_Q.setParameter("lv_lastName", lv_lastName);
