				...
				<div id="pfCreate" style="margin-top: 50px;"
						...
						<div class="panel panel-primary">
								...
								<div class="panel-heading">
										<div class="panel-title">Create Portfolio</div>
								</div>
								...
								<div style="padding-top: 30px" class="panel-body">
										...
										<!-- Create Portfolio -->
										<form:form
												action="${pageContext.request.contextPath}/pf/processCreatePF"
												modelAttribute="newPF" class="form-horizontal" method="POST">
