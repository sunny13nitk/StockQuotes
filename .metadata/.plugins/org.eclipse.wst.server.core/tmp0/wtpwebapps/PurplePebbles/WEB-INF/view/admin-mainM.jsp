						...
						<div class="cell-8">
								<div class="row">
										...
										<div class="cell-2 offset-1"
												...
												<a href="${pageContext.request.contextPath}/admin/upload"
														data-role="tile" data-size="small"
														class="bg-transparent border
														 border-radius-4 "
														style="border-color: #4652A0"> <span
														class='mif-upload icon mif-5x' style="color: #4652A0"></span>
												</a>
										</div>
										<!--Content  -->
										<div class="cell-6" style="margin-top: -2px;">
												<h6 style="color: #601f80">Upload Scrip</h6>
												<small style="color: #601f80">Brief: <cite
														title="Brief">Upload the Scrip XLS in System.
																Handles Create/Update with reported Statistics</cite>
												</small>
								...
								<div class="row">
										...
										<div class="cell-2 offset-1"
												...
												<a href="https://github.com/olton/Metro-UI-CSS"
														...
														class="bg-transparent border
														 border-radius-4 "
														style="border-color: #0F5583"> <span
														class='mif-command icon mif-5x ' style="color: #0F5583"></span>
												</a>
										</div>

										<!--Content  -->
										<div class="cell-6" style="margin-top: -2px;">
												<h6 style="color: #601f80">Scrips Ageing Report</h6>
												<small style="color: #601f80">Brief: <cite
														title="Brief">Get Scrips Ageing Report to Refresh
																Scrips with Older Data</cite>
												</small>
