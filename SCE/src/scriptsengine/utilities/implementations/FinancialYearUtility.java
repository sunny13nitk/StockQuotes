...
/**
 * Class for Financial Year Computation - Static Methods
 * Financial Year is in terms of Assement Year = CFY + 1
 */
public class FinancialYearUtility
{
	...
	/**
	 * Get Current Financial Year in String format FY - xxxx/yy
	 * Financial Year is in terms of Assement Year = CFY + 1
	 * 
	...
	/**
	 * Get Financial Year in String format FY - xxxx/yy for a particular Date
	 * Financial Year is in terms of Assement Year = CFY + 1
	 * 
	 * @param d
	 *             - Date input - javaUtil.Date
	 * @return - Financial Year in String format
	 */
	public static String getFinancialYearforDate(Date d)
	{
		String FYear = null;
