package scriptsengine.utilities.dateStringUtil.JAXB.implementations;
...
import scriptsengine.utilities.dateStringUtil.JAXB.definitions.Months;
import scriptsengine.utilities.dateStringUtil.JAXB.definitions.PathsJAXBMO;
import scriptsengine.utilities.dateStringUtil.JAXB.definitions.monthNames;
...
public class monthsConfig_JAXB implements IJaxable
{
	...
	public void setPathConstants(PathsJAXBMO pathConstants)
	{
	...
	public monthsConfig_JAXB(PathsJAXBMO pathConstants)
	{
		super();
		this.pathConstants = pathConstants;
	}
	...
	public <T> ArrayList<T> Load_XML_to_Objects() throws Exception
	{
		...
		try
		{
			...
			InputStream is = this.getClass().getClassLoader().getResourceAsStream(this.getPathConstants().getJaxPath_MO_xml());
