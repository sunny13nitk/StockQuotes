package scriptsengine.utilities.dateStringUtil.types;
...
public class MonthYearInfo
{
	...
	public void setMonthInfo(monthsConfig monthInfo)
	{
	...
	public MonthYearInfo(monthsConfig monthInfo, int year)
	{
		super();
		this.monthInfo = monthInfo;
		Year = year;
