...
import scriptsengine.uploadengineSC.tools.interfaces.IHeadersConvSrv;
...
public class SheetHeadersSrv implements ISheetHeadersSrv
{
	...
	@Override
	public <T> ArrayList<T> getHeadersbySheet(XSSFSheet sheetRef) throws EX_General
	{
	...
	@Override
	public <T> ArrayList<T> getHeadersbyWbPathandSheetName(String wbPath, String sheetName) throws EX_General
	{
		ArrayList<T> list = null;
	...
	@Override
	public <T> ArrayList<T> getHeadersbywbCtxtandSheetName(XSSFWorkbook wbCtxt, String sheetName) throws EX_General
	{
		ArrayList<T> list = null;
	...
	private <T> ArrayList<T> getHeadersforSheet(XSSFSheet sheetRef, String sheetName) throws EX_General
	{
						...
						if (cellIterator != null)
						{
							...
							while (cellIterator.hasNext())
							{
								...
								if (headScanConfig.getRowScanType() == rowScanType.Continous)
								{
									...
									if (colpos >= (headScanConfig.getColToScanStart() - 1)
										...
										if (cell != null)
										{
											...
											if (headScanConfig.isCheckNullVals())
											{
												...
												if (rowVals != null)
												{
													...
													val = this.getValuefromCell(cellVal, headScanConfig.getValrowDataType(), evaluator);
													if (val != null)
													{
											...
											else
											{
												...
												list.add((T) getValuefromCell(cell, headScanConfig.getRowDataType(), evaluator));
											}
										}
									}
		...
		if (list != null)
		{
			if (list.size() > 0)
			{
				...
				{
					IHeadersConvSrv hdrConvSrv = (IHeadersConvSrv) appctxt.getBean(headScanConfig.getHeaderValsConvBean());
					if (hdrConvSrv != null)
					{
	...
	@SuppressWarnings("unchecked")
	private <T> T getValuefromCell(Cell cell, SCEenums.rowDataType dataType, FormulaEvaluator eval) throws EX_General
	{
		Object val = null;
