package scriptsengine.uploadengineSC.tools.definitions;
...
public class EntityListHeadScannerConfig
{
	...
	public void setHeaderValsConvBean(String headerValsConvBean)
	{
	...
	public void setRowToScan(int rowToScan)
	{
	...
	public void setColToScanStart(int colToScanStart)
	{
	...
	public void setColToScanEnd(int colToScanEnd)
	{
	...
	public void setRowScanType(SCEenums.rowScanType rowScanType)
	{
	...
	public void setRowDataType(SCEenums.rowDataType rowDataType)
	{
	...
	public void setCheckNullVals(boolean checkNullVals)
	{
	...
	public void setNullValRowPos(int nullValRowPos)
	{
	...
	public void setValrowDataType(SCEenums.rowDataType valrowDataType)
	{
	...
	public void setHeaderDataType(SCEenums.rowDataType headerDataType)
	{
		this.headerDataType = headerDataType;
	}

	public EntityListHeadScannerConfig(int rowToScan, int colToScanStart, int colToScanEnd, scriptsengine.enums.SCEenums.rowScanType rowScanType,
	          scriptsengine.enums.SCEenums.rowDataType rowDataType, scriptsengine.enums.SCEenums.rowDataType valrowDataType, boolean checkNullVals,
	          int nullValRowPos, String headerValsConvBean, String objField, scriptsengine.enums.SCEenums.rowDataType headerDataType)
	{
		super();
		this.rowToScan = rowToScan;
		this.colToScanStart = colToScanStart;
