...
@Service("AlertProcessor_EPS")
public class AlertProcessor_EPS implements IAlertAware
{
			...
			if (attrContainer.getDeltaFigures() != null)
			{
				...
				if (attrContainer.getDeltaFigures().size() >= timePeriod)
				{
					...
					if (alertTriggered == true)
					{
						...
						GeneralMessage msgChgErr = new GeneralMessage("AL_EPSTREND", new Object[]
					...
					{
						/** Alert Messages **/
						GeneralMessage msgChgErr = new GeneralMessage("AL_EPSCURR", new Object[]
