...
@Service("AlertProcessor_RsrvProvRatio")
public class AlertProcessor_RsrvProvRatio implements IAlertAware
{
	@Autowired
			...
			if (attrContainer.getDeltaFigures() != null)
			{
				...
				if (attrContainer.getDeltaFigures().size() >= timePeriod)
				{
					...
					if (alertTriggered == true)
					{
						...
						GeneralMessage msgChgErr = new GeneralMessage("AL_NETTRPRTREND", new Object[]
					...
					if (alertTriggered2 == true)
					{
						...
						// {1} years!!
						GeneralMessage msgChgErr = new GeneralMessage("AL_NETTRPRCURR", new Object[]
