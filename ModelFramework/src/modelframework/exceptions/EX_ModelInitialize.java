...
public class EX_ModelInitialize extends Exception implements IPropertyAwareMessage
	{
		...
		public EX_ModelInitialize(String InnerExceptionmsg)
			{
				this.Args = new Object[] { InnerExceptionmsg };
				this.setProperty_ID("ERR_INITIALIZE_FW");
