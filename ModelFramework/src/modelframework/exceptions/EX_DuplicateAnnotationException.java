...
/**
 * ERR_DUPLANNOT= Annotation - {0} must only be implmented once for Object Class - {1}
 * Annotation specified Twice in a Class while it ought to be only once
 */
...
public class EX_DuplicateAnnotationException extends Exception implements IPropertyAwareMessage
	{
		...
		public EX_DuplicateAnnotationException(Object[] args)
			{
				this.Args = args;
