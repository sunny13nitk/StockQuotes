...
import root.scripsEngine.utilities.interfaces.IDurationValdiateService;
import root.scripsEngine.utilities.types.CurrentFinancialPeriod;

@Service(
    "DurationValidateService"
)
@Scope(
