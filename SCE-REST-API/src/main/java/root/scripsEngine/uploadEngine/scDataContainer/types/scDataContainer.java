package root.scripsEngine.uploadEngine.scDataContainer.types;

import java.util.List;

import root.scripsEngine.annotations.SheetName;
import root.scripsEngine.uploadEngine.entities.EN_SC_10YData;
import root.scripsEngine.uploadEngine.entities.EN_SC_BalSheet;
import root.scripsEngine.uploadEngine.entities.EN_SC_GeneralQ;
import root.scripsEngine.uploadEngine.entities.EN_SC_Last4QData;
import root.scripsEngine.uploadEngine.entities.EN_SC_Quarters;
import root.scripsEngine.uploadEngine.entities.EN_SC_Trends;
